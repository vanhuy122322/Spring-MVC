...
<!-- Header -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						<li data-image="images/single_4.jpg"><img src="resources/${product.getImage() }" alt=""></li>
						<li data-image="images/single_2.jpg"><img src="resources/${product.getImage() }" alt=""></li>
						<li data-image="images/single_3.jpg"><img src="resources/${product.getImage() }" alt=""></li>
					</ul>
				</div>

				<!-- Selected Image -->
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected"><img src="resources/${product.getImage() }" alt=""></div>
				</div>

				<!-- Description -->
				<div class="col-lg-5 order-3">
					<div class="product_description">
						<div class="product_category">${product.getTitle() }</div>
						...
						<div class="order_info d-flex flex-row">
							<form action="#">
								...
								<div class="button_container">
									<a href="AddCart/${product.id} " type="button" >Thêm vào giỏ hàng</a>
	...
	<!-- Recently Viewed -->
          ...
          <jsp:include page = "relate_product.jsp"></jsp:include>
